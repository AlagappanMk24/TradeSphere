...
{
    public class AuthRepository(UserManager<ApplicationUser> userManager, IConfiguration? configuration, IEmailService? emailService) : IAuthRepository
    {
        ...
        public async Task AddDefaultRole(ApplicationUser ApplicationUser, string roleName)
        {
            var defaultRole = "User";
            await userManager.AddToRoleAsync(ApplicationUser, defaultRole);
        }
